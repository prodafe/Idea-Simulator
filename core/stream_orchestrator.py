...
步骤2: 估算基准成功率。必须基于真实世界数据，不能拍脑袋。以下为参考基准：
- daily_life: 95-99.9%（日常事务几乎必成）
- career_job: 科技/AI岗录取率约8-12%，金融投行约3-5%，普通岗位约15-25%
  强背景(名校+相关经验+内推): 30-60% | 弱背景: 5-15%
- business_startup: 全球创业5年存活率约15%，AI/科技方向略高(18-25%)
  强资源(资金充足+团队完善): 20-35% | 弱资源: 5-12%
- investment: 指数基金长期年化~10% | 风投~15%但90%项目归零
- education: 高考985录取率~1.5% | 考研录取率~25% | 考公~2%
- negotiation: 薪资谈判(有offer): 60-80% | 商务合作: 30-60%
- relocation: 国内跨城: 85-95% | 跨国: 60-85%
- legal: 民事胜诉(证据充分): 60-85% | 刑事辩护: 20-50%
- health: 感冒自愈~98% | 手术成功~97% | 癌症5年生存(早期)~90%
